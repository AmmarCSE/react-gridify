...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.retrieveFilterItemsDelegate = undefined;
	...
	var _actions3 = __webpack_require__(190);

	var _Filters = __webpack_require__(191);
	...
	var _Pager = __webpack_require__(202);
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      dispatch((0, _actions.fetchFilterData)(search));
	      dispatch((0, _actions2.fetchGridData)(search));
	      dispatch((0, _actions3.fetchPagerData)(search));
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_Filters2.default, { injectFilterItemsDelegate: function injectFilterItemsDelegate(implementor) {
	            return exports.retrieveFilterItemsDelegate = retrieveFilterItemsDelegate = implementor;
	          } }),
	...
	var retrieveFilterItemsDelegate = exports.retrieveFilterItemsDelegate = null;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.FILTER_TRIGGERED = exports.RECEIVE_FILTERDATA = exports.REQUEST_FILTERDATA = undefined;
	exports.fetchFilterDataIfNeeded = fetchFilterDataIfNeeded;
	exports.fetchFilterData = fetchFilterData;
	exports.triggerFilter = triggerFilter;

	var _utils = __webpack_require__(188);

	var REQUEST_FILTERDATA = exports.REQUEST_FILTERDATA = 'REQUEST_FILTERDATA';
	var RECEIVE_FILTERDATA = exports.RECEIVE_FILTERDATA = 'RECEIVE_FILTERDATA';
	var FILTER_TRIGGERED = exports.FILTER_TRIGGERED = 'FILTER_TRIGGERED';

	function fetchFilterDataIfNeeded(search) {
	...
	function shouldFetchFilterData(state, search) {
	  return true;
	  var posts = state.postsByReddit[search];
	  if (!posts) {
	    return true;
	  }
	  if (posts.isFetching) {
	...
	function fetchFilterData(search) {
	  return function (dispatch) {
	    ...
	    (0, _utils.ajax)('GET', '[be]/filters', function (json) {
	      dispatch(receiveFilterData(search, json));
	    }, search);
	  };
	}
	...
	function triggerFilter(callback, filterItems, dispatch) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CANCELED_EDIT_ROW = exports.CANCELED_ADD_ROW = exports.DELETED_ROW = exports.COMMITED_ROW = exports.EDIT_ROW = exports.ADDED_ROW = exports.ADD_ROW = exports.RECEIVE_GRIDDATA = exports.REQUEST_GRIDDATA = undefined;
	exports.addRow = addRow;
	exports.commitAddRow = commitAddRow;
	exports.addedRow = addedRow;
	exports.editRow = editRow;
	exports.commitRow = commitRow;
	exports.commitedRow = commitedRow;
	exports.deleteRow = deleteRow;
	exports.deletedRow = deletedRow;
	exports.canceledAddRow = canceledAddRow;
	exports.canceledEditRow = canceledEditRow;
	exports.fetchGridData = fetchGridData;
	exports.fetchGridDataIfNeeded = fetchGridDataIfNeeded;

	var _utils = __webpack_require__(188);

	var REQUEST_GRIDDATA = exports.REQUEST_GRIDDATA = 'REQUEST_GRIDDATA';
	var RECEIVE_GRIDDATA = exports.RECEIVE_GRIDDATA = 'RECEIVE_GRIDDATA';
	var ADD_ROW = exports.ADD_ROW = 'ADD_ROW';
	var ADDED_ROW = exports.ADDED_ROW = 'ADDED_ROW';
	var EDIT_ROW = exports.EDIT_ROW = 'EDIT_ROW';
	var COMMITED_ROW = exports.COMMITED_ROW = 'COMMITED_ROW';
	var DELETED_ROW = exports.DELETED_ROW = 'DELETED_ROW';
	var CANCELED_ADD_ROW = exports.CANCELED_ADD_ROW = 'CANCELED_ADD_ROW';
	var CANCELED_EDIT_ROW = exports.CANCELED_EDIT_ROW = 'CANCELED_EDIT_ROW';
	...
	function commitAddRow(newRow, index) {
	  return function (dispatch) {
	    (0, _utils.ajax)('POST', '[be]/add', function (commitedRow) {
	      dispatch(addedRow(commitedRow, index));
	    }, newRow);
	  };
	}

	function addedRow(newRow, index) {
	  return {
	    type: ADDED_ROW,
	    newRow: newRow,
	    index: index
	...
	function commitRow(touchedRow, index) {
	  return function (dispatch) {
	    (0, _utils.ajax)('POST', '[be]/update', function (commitedResult) {
	      dispatch(commitedRow(index, commitedResult));
	    }, touchedRow);
	  };
	}

	function commitedRow(index, newRow) {
	  return {
	    type: COMMITED_ROW,
	    index: index,
	    newRow: newRow
	...
	function deleteRow(index, key) {
	  return function (dispatch) {
	    (0, _utils.ajax)('POST', '[be]/delete', function () {
	      dispatch(deletedRow(index));
	    }, key);
	  };
	}
	...
	function canceledEditRow(index) {
	  return {
	...
	function fetchGridData(search) {
	  return function (dispatch) {
	    ...
	    (0, _utils.ajax)('GET', '[be]/search', function (json) {
	      dispatch(receiveGridData(search, json));
	    }, search);
	  };
	}
	...
	function fetchGridDataIfNeeded(search) {
	  return function (dispatch, getState) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.PAGER_TRIGGERED = exports.RECEIVE_PAGERDATA = exports.REQUEST_PAGERDATA = undefined;
	exports.fetchPagerData = fetchPagerData;
	exports.triggerPager = triggerPager;

	var _utils = __webpack_require__(188);

	var REQUEST_PAGERDATA = exports.REQUEST_PAGERDATA = 'REQUEST_PAGERDATA';
	var RECEIVE_PAGERDATA = exports.RECEIVE_PAGERDATA = 'RECEIVE_PAGERDATA';
	var PAGER_TRIGGERED = exports.PAGER_TRIGGERED = 'PAGER_TRIGGERED';

	function fetchPagerData(search, page) {
	  return function (dispatch) {
	    dispatch(requestPagerData(search));
	    (0, _utils.ajax)('GET', '[be]/pagerData', function (json) {
	      dispatch(receivePagerData(json));
	    }, search);
	  };
	}
	...
	function triggerPager(callback, filterItems, dispatch) {
	  callback(filterItems, dispatch);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FiltersView = __webpack_require__(192);
	...
	var Filters = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_FiltersView2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterHolder = __webpack_require__(193);

	var _FilterHolder2 = _interopRequireDefault(_FilterHolder);
	...
	var FiltersView = function (_Component) {
	  _inherits(FiltersView, _Component);

	  function FiltersView(props) {
	    _classCallCheck(this, FiltersView);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(FiltersView).call(this, props));

	    _this.handleFilterTrigger = _this.handleFilterTrigger.bind(_this);
	    _this.retrieveFilterItems = _this.retrieveFilterItems.bind(_this);

	    _this.props.injectFilterItemsDelegate(function () {
	      return _this.retrieveFilterItems();
	    });
	    return _this;
	  }

	  _createClass(FiltersView, [{
	    key: 'handleFilterTrigger',
	    value: function handleFilterTrigger() {
	      //retrieve items through child cascade call
	      var filterItems = this.retrieveFilterItems();
	      (0, _actions.triggerFilter)(_config.triggerFilterCallback, filterItems, this.props.dispatch);
	    }
	  }, {
	    key: 'retrieveFilterItems',
	    value: function retrieveFilterItems() {
	      var _this2 = this;

	      //retrieve items through child cascade call
	      return Object.keys(this.refs).reduce(function (aggregate, current) {
	        var filterItem = _this2.refs[current].generateFilterItem();
	        if (filterItem) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        Object.keys(filters).map(function (filterKey, index) {
	          return _react2.default.createElement(_FilterHolder2.default, {
	            key: (0, _utils.generateReactKey)(),
	            triggerFilterHandler: _this3.handleFilterTrigger,
	...
	exports.default = (0, _reactRedux.connect)()(FiltersView);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CheckboxFilter = __webpack_require__(194);
	...
	var FilterHolder = function (_Component) {
	    _inherits(FilterHolder, _Component);

	    function FilterHolder() {
	        _classCallCheck(this, FilterHolder);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FilterHolder).apply(this, arguments));
	    }

	    _createClass(FilterHolder, [{
	        key: 'generateFilterItem',


	        //have this be an 'inverted inheritance' call since the parent needs to gather items from all filters
	        value: function generateFilterItem() {
	        ...
	        value: function render() {
	            ...
	            var triggerFilterHandler = _props.triggerFilterHandler;
	...
	exports.default = FilterHolder;


	var filterTypeMap = {
	    'multiple': function multiple(filter, triggerFilterHandler) {
	        return _react2.default.createElement(_CheckboxFilter2.default, {
	            key: (0, _utils.generateReactKey)(),
	            items: filter.items,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckboxFilter = function (_Component) {
	    ...
	    function CheckboxFilter(props) {
	        ...
	        _this.generateFilterItem = _this.generateFilterItem.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(CheckboxFilter, [{
	        ...
	        key: '_createFilterItem',
	        value: function _createFilterItem(value) {
	            return {
	        ...
	        value: function render() {
	            ...
	            var _props = this.props;
	            var filterIdentifier = _props.filterIdentifier;
	            var filterOperator = _props.filterOperator;
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement('input', {
	                                ...
	                                onChange: function onChange(event) {
	                                    var filterItem = event.target.checked ? _this2._createFilterItem(event.target.value) : false;
	                                    _this2.filterItem = filterItem;
	                                    triggerFilterHandler();
	                                } }),
	                            _react2.default.createElement(
	                                'label',
	                                { htmlFor: filterIdentifier + index },
	                                item.value
	                            )
	                        )
	                    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.dropdownFields = exports.triggerPageCallback = exports.triggerFilterCallback = exports.searchPath = exports.rowKey = undefined;
	...
	var rowKey = 'product_id';

	var searchPath = 'product_id';

	var triggerFilterCallback = function triggerFilterCallback(filterItems, dispatch) {
	    dispatch((0, _actions.fetchGridData)({ filterItems: filterItems }));
	    dispatch((0, _actions2.fetchPagerData)({ filterItems: filterItems }));
	};
	var triggerPageCallback = function triggerPageCallback(page, dispatch) {
	    var filterItems = (0, _App.retrieveFilterItemsDelegate)();

	    dispatch((0, _actions.fetchGridData)({ filterItems: filterItems, page: page }));
	    dispatch((0, _actions2.fetchPagerData)({ filterItems: filterItems, page: page }));
	};
	...
	var dropdownFields = {
	    ...
	    'brand_name': function () {
	        return {
	            dataList: sqlAgent.query('SELECT DISTINCT brand_id, brand_name FROM brands JOIN products ON products.brand_id = brands.brand_id ORDER BY brand_name').map(function (row) {
	    ...
	    'supplier_name': function () {
	        return {
	            dataList: sqlAgent.query('SELECT DISTINCT supplier_id, supplier_name FROM suppliers JOIN products ON products.supplier_id = suppliers.supplier_id ORDER BY supplier_name').map(function (row) {
	...
	exports.triggerFilterCallback = triggerFilterCallback;
	exports.triggerPageCallback = triggerPageCallback;
	exports.dropdownFields = dropdownFields;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GridView = __webpack_require__(197);
	...
	var mapStateToProps = function mapStateToProps(state) {
	  ...
	  var editRows = state.editRows;
	  var addRows = state.addRows;
	...
	var Grid = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_GridView2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GridView = function (_Component) {
	    ...
	    function GridView(props) {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GridView).call(this, props));

	        _this.onAddRowClick = _this.onAddRowClick.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(GridView, [{
	        ...
	        value: function onAddRowClick() {
	            this.props.dispatch((0, _index.addRow)(this.props.data.length));
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            var editRows = _props.editRows;
	            var onEditRowClick = _props.onEditRowClick;
	            var addRows = _props.addRows;


	            return _react2.default.createElement(
	                'div',
	                { className: 'grid-components' },
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'thead',
	                            null,
	                            _react2.default.createElement(_HeaderRow2.default, { headers: headers })
	                        ),
	                        _react2.default.createElement(
	                            'tbody',
	                            null,
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'add-row', onClick: this.onAddRowClick },
	                        'Add New'
	                    )
	                )
	            );
	...
	exports.default = (0, _reactRedux.connect)()(GridView);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderRow = function HeaderRow(_ref) {
	    ...
	    return _react2.default.createElement(
	        'tr',
	        null,
	        headers.map(function (headerKeyVal) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Row = function (_Component) {
	    ...
	    function Row(props) {
	        ...
	        var handlers = ['onEditRowClick', 'onCommitRowClick', 'aggregateRowState', 'onDeleteRowClick', 'onCommitNewRowClick', 'onCancelAddRowClick', 'onCancelEditRowClick'];
	    ...
	    _createClass(Row, [{
	        ...
	        key: 'onEditRowClick',
	        value: function onEditRowClick() {
	            //index is initally passed in but we dont explitly indicate that in rendered since it is not used there
	            this.props.dispatch((0, _index.editRow)(this.props.index));
	        }
	    }, {
	        key: 'onCommitRowClick',
	        value: function onCommitRowClick() {
	            this.state = this.state || {};

	            this.state[_config.rowKey] = this.props.rowData[_config.rowKey];
	            this.props.dispatch((0, _index.commitRow)(this.state, this.props.index));
	        }
	    }, {
	        key: 'onCommitNewRowClick',
	        value: function onCommitNewRowClick() {
	            this.state = this.state || {};
	            this.props.dispatch((0, _index.commitAddRow)(this.state, this.props.index));
	        }
	    }, {
	        key: 'onDeleteRowClick',
	        value: function onDeleteRowClick() {
	            confirm(alertMessageMap['delete']) && this.props.dispatch((0, _index.deleteRow)(this.props.index, this.props.rowData[_config.rowKey]));
	        }
	    }, {
	        key: 'onCancelAddRowClick',
	        value: function onCancelAddRowClick() {
	            confirm(alertMessageMap['cancel']) && this.props.dispatch((0, _index.canceledAddRow)(this.props.index));
	        }
	    }, {
	        key: 'onCancelEditRowClick',
	        value: function onCancelEditRowClick() {
	            confirm(alertMessageMap['cancel']) && this.props.dispatch((0, _index.canceledEditRow)(this.props.index));
	        }
	    }, {
	        key: 'aggregateRowState',
	        value: function aggregateRowState(name, value) {
	            var originalName = name;
	            if (~Object.keys(_config.dropdownFields).indexOf(originalName)) {
	                value = _config.dropdownFields[originalName].dataList.find(function (row) {
	                    return row.value == value;
	                }).key;
	                name = _config.dropdownFields[originalName].key;
	            }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                headers.map(function (headerKeyVal) {
	                    var rowKey = Object.keys(headerKeyVal)[0];
	                    return _react2.default.createElement(_Cell2.default, {
	                        key: (0, _utils.generateReactKey)(),
	                        propertyKey: rowKey,
	                        value: rowData[rowKey],
	                        mode: mode,
	                        aggregateRowState: _this2.aggregateRowState
	                    });
	                }),
	                _react2.default.createElement(
	                    'td',
	                    ...
	                    function () {
	                        if (!mode) {
	                            return _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement('span', { className: 'edit-row icon', onClick: _this2.onEditRowClick }),
	                                _react2.default.createElement('span', { className: 'delete-row icon', onClick: _this2.onDeleteRowClick })
	                            );
	                        } else if (mode == 'edit') {
	                            return _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement('span', { className: 'commit-row icon', onClick: _this2.onCommitRowClick }),
	                                _react2.default.createElement('span', { className: 'cancel-operation-row icon', onClick: _this2.onCancelEditRowClick })
	                            );
	                        } else if (mode == 'add') {
	                            return _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement('span', { className: 'add-row-icon icon', onClick: _this2.onCommitNewRowClick }),
	                                _react2.default.createElement('span', { className: 'cancel-operation-row icon', onClick: _this2.onCancelAddRowClick })
	                            );
	                        }
	                    }()
	                )
	...
	exports.default = Row;
	exports.default = (0, _reactRedux.connect)()(Row);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Cell = function (_Component) {
	    ...
	    _createClass(Cell, [{
	        ...
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.preStateDirectives.forEach(function (directive) {
	                return directive();
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            var _props = this.props;
	            var propertyKey = _props.propertyKey;
	            var mode = _props.mode;
	            var aggregateRowState = _props.aggregateRowState;

	            var value = this.props.value;
	            //transform limited option properties to dropdown boxes
	            var className = '',
	                dataList = '';
	            if (~Object.keys(_config.dropdownFields).indexOf(propertyKey) && mode) {
	                className = 'awesomplete awesomplete-fresh';
	                dataList = _config.dropdownFields[propertyKey].dataList.map(function (row) {
	                    return row.value;
	                }).join(',');

	                if (!value) {
	                    value = _config.dropdownFields[propertyKey].dataList.length ? _config.dropdownFields[propertyKey].dataList[0].value : '';
	                    this.preStateDirectives.push(function () {
	                        return aggregateRowState(propertyKey, value);
	                    });
	                }
	            }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PagerView = __webpack_require__(203);

	var _PagerView2 = _interopRequireDefault(_PagerView);
	...
	var Pager = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_PagerView2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PagerView = function (_Component) {
	    _inherits(PagerView, _Component);

	    function PagerView(props) {
	        _classCallCheck(this, PagerView);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PagerView).call(this, props));
	    }

	    _createClass(PagerView, [{
	        key: 'onPageClick',
	        value: function onPageClick(page) {
	            (0, _config.triggerPageCallback)(page, this.props.dispatch);
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            if (pageCount < 11) {
	                pageSections = [[].concat(_toConsumableArray(Array(pageCount).keys())).map(function (num) {
	                    return ++num;
	                })];
	            } else if (pageCount == 11) {
	                pageSections = [[].concat(_toConsumableArray(Array(5).keys())).map(function (num) {
	                    return ++num;
	                }), pageSeperator, [].concat(_toConsumableArray(Array(5).keys())).map(function (num) {
	                    return num += 7;
	                })];
	            } else {
	                var middle = Math.ceil(pageCount / 2);
	                pageSections = [[].concat(_toConsumableArray(Array(4).keys())).map(function (num) {
	                    return ++num;
	                }), pageSeperator, [middle, middle + 1], pageSeperator, [].concat(_toConsumableArray(Array(4).keys())).map(function (num) {
	                    return num += pageCount - 3;
	                })];
	            }

	            var pages = [];
	            pageSections.forEach(function (pageSection) {
	                return pages = pages.concat(pageSection.map(function (page) {
	                    return _react2.default.createElement(
	                        'span',
	                        { className: 'page' + (page == currentPage ? ' current' : ''), onClick: _this2.onPageClick.bind(_this2, page - 1), key: (0, _utils.generateReactKey)() },
	                        page
	                    );
	                }));
	            });
	...
	exports.default = (0, _reactRedux.connect)()(PagerView);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducers2 = __webpack_require__(208);

	var _reducers3 = __webpack_require__(209);

	var rootReducer = (0, _redux.combineReducers)({
	    data: _reducers.dataReducer,
	    headers: _reducers.headerReducer,
	    editRows: _reducers.editRowsReducer,
	    addRows: _reducers.addRowsReducer,
	    pageCount: _reducers2.pageCountReducer,
	    currentPage: _reducers2.currentPageReducer,
	    filters: _reducers3.filtersReducer
	});
...
/***/ function(module, exports) {
	...
	exports.editRowsReducer = editRowsReducer;
	exports.addRowsReducer = addRowsReducer;
	...
	function dataReducer() {
	  ...
	  switch (action.type) {
	    case 'ADD_ROW':
	      return [].concat(_toConsumableArray(state), [action.newRow]);
	    case 'ADDED_ROW':
	    case 'COMMITED_ROW':
	      var cloned = [].concat(_toConsumableArray(state));
	    ...
	    case 'DELETED_ROW':
	      return [].concat(_toConsumableArray(state.filter(function (trash, index) {
	...
	function editRowsReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	  var action = arguments[1];

	  switch (action.type) {
	    case 'EDIT_ROW':
	      return [].concat(_toConsumableArray(state), [action.index]);
	    case 'CANCELED_EDIT_ROW':
	    case 'COMMITED_ROW':
	      return [].concat(_toConsumableArray(state.filter(function (index) {
	        return index != action.index;
	      })));
	    case 'RECEIVE_GRIDDATA':
	      return [];
...
/***/ function(module, exports) {
	...
	exports.pageCountReducer = pageCountReducer;
	exports.currentPageReducer = currentPageReducer;
	function pageCountReducer() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function filtersReducer() {
	  ...
	  switch (action.type) {
	    case _actions.RECEIVE_FILTERDATA:
